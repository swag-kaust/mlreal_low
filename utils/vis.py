...
def plot_signal(signals, dt=None, title='', xlabel='Time, sec', ylabel='', legend=None, **kwargs):
...
def plot_log_model(mm, dx, nx0=None, nz0=None, src=None, title='', log=None, log_location=None, cmap='RdBu_r', axis=True, cax_label='km/s', dpi=None, fig_ax=None, **kwargs):
    v = mm.copy() / 1000
    if fig_ax is None:
        fig = plt.figure()
        ax = plt.gca()
